# check_models.py - A script to see which Gemini models are available to your API key.
...
if not api_key:
    console.print("[bold red]ERROR: GOOGLE_API_KEY not found in your .env file.[/bold red]")
    exit()
...
try:
    ...
    for model in genai.list_models():
        # The error message specifically mentioned 'generateContent', so we check for it.
